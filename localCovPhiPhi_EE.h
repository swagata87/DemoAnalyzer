...
#ifndef localCovPhiPhi_EE_h
#define localCovPhiPhi_EE_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   localCovPhiPhi_EE(TTree *tree=0);
   virtual ~localCovPhiPhi_EE();
...
#ifdef localCovPhiPhi_EE_cxx
localCovPhiPhi_EE::localCovPhiPhi_EE(TTree *tree) : fChain(0) 
{
...
localCovPhiPhi_EE::~localCovPhiPhi_EE()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t localCovPhiPhi_EE::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t localCovPhiPhi_EE::LoadTree(Long64_t entry)
{
...
void localCovPhiPhi_EE::Init(TTree *tree)
{
...
Bool_t localCovPhiPhi_EE::Notify()
{
...
void localCovPhiPhi_EE::Show(Long64_t entry)
{
...
Int_t localCovPhiPhi_EE::Cut(Long64_t entry)
{
...
#endif // #ifdef localCovPhiPhi_EE_cxx
