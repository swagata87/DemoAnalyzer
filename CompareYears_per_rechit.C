...
int CompareYears_per_rechit() {
  ...
  //////// Output File /////////
  TFile* outputFile = new TFile("compare_years_sieie_per_rechit.root","RECREATE");
  outputFile->cd();
  ...
  leg_example->SetHeader("Sieie, per recHit cut, real e, barrel","C"); // option "C" allows to center the header
  ...
  my_canvas1->SaveAs("DefaultSieie_years_barrel_per_rechit.png");
  ...
  h1_my_SigmaIetaIeta_per_rechit_signal_endcap_2024->GetXaxis()->SetRangeUser(0, 0.08);

  TH1D* h1_my_SigmaIetaIeta_per_rechit_signal_endcap_2023 = (TH1D*)file_2023->Get("h1_my_SigmaIetaIeta_per_rechit_signal_endcap");
  h1_my_SigmaIetaIeta_per_rechit_signal_endcap_2023->Rebin(4);
  h1_my_SigmaIetaIeta_per_rechit_signal_endcap_2023->SetLineColor(kRed);
  h1_my_SigmaIetaIeta_per_rechit_signal_endcap_2023->SetLineWidth(3);
  h1_my_SigmaIetaIeta_per_rechit_signal_endcap_2023->Scale(1/h1_my_SigmaIetaIeta_per_rechit_signal_endcap_2023->GetEntries());

  TH1D* h1_my_SigmaIetaIeta_per_rechit_signal_endcap_2021 = (TH1D*)file_2021->Get("h1_my_SigmaIetaIeta_per_rechit_signal_endcap");
  h1_my_SigmaIetaIeta_per_rechit_signal_endcap_2021->Rebin(4);
  h1_my_SigmaIetaIeta_per_rechit_signal_endcap_2021->SetLineColor(kGreen+1);
  h1_my_SigmaIetaIeta_per_rechit_signal_endcap_2021->SetLineWidth(3);
  h1_my_SigmaIetaIeta_per_rechit_signal_endcap_2021->Scale(1/h1_my_SigmaIetaIeta_per_rechit_signal_endcap_2021->GetEntries());

  TH1D* h1_my_SigmaIetaIeta_per_rechit_signal_endcap_2018 = (TH1D*)file_2018->Get("h1_my_SigmaIetaIeta_per_rechit_signal_endcap");
  h1_my_SigmaIetaIeta_per_rechit_signal_endcap_2018->Rebin(4);
  h1_my_SigmaIetaIeta_per_rechit_signal_endcap_2018->SetLineColor(kGray+1);
  h1_my_SigmaIetaIeta_per_rechit_signal_endcap_2018->SetLineWidth(3);
  h1_my_SigmaIetaIeta_per_rechit_signal_endcap_2018->Scale(1/h1_my_SigmaIetaIeta_per_rechit_signal_endcap_2018->GetEntries());
  ...
  leg_example2->SetHeader("Sieie, per recHit cut, real e, endcap","C"); // option "C" allows to center the header
  ...
  my_canvas2->SaveAs("DefaultSieie_years_endcap_per_rechit.png");
