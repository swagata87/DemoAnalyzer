...
#ifdef DrawROC_EE_cxx
DrawROC_EE::DrawROC_EE(TTree *tree) : fChain(0) 
{
...
DrawROC_EE::~DrawROC_EE()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t DrawROC_EE::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t DrawROC_EE::LoadTree(Long64_t entry)
{
...
void DrawROC_EE::Init(TTree *tree)
{
...
void DrawROC_EE::Show(Long64_t entry)
{
...
Int_t DrawROC_EE::Cut(Long64_t entry)
{
