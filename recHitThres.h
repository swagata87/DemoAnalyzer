...
// Wed Nov 13 15:37:33 2019 by ROOT version 6.14/09
// from TTree EventTree/EventData
// found on file: RedefNtup_AOD_2018.root
//////////////////////////////////////////////////////////

#ifndef recHitThres_h
#define recHitThres_h
...
#ifdef recHitThres_cxx
recHitThres::recHitThres(TTree *tree) : fChain(0) 
{
...
recHitThres::~recHitThres()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t recHitThres::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t recHitThres::LoadTree(Long64_t entry)
{
...
void recHitThres::Init(TTree *tree)
{
...
void recHitThres::Show(Long64_t entry)
{
...
Int_t recHitThres::Cut(Long64_t entry)
{
