...
int CompareYears1() {
  ...
  h1_my_SigmaIetaIeta_signal_barrel_2023->Rebin(2);
  ...
  h1_my_SigmaIetaIeta_signal_barrel_2021->Rebin(2);
  ...
  h1_my_SigmaIetaIeta_signal_barrel_2018->Rebin(2);
  ...
  h1_my_SigmaIetaIeta_signal_barrel_2021->Draw("same");
  h1_my_SigmaIetaIeta_signal_barrel_2023->Draw("same");
  ...
  my_canvas1->SaveAs("DefaultSieie_years_barrel.png");
  ...
  h1_my_SigmaIetaIeta_signal_endcap_2024->GetXaxis()->SetRangeUser(0, 0.08);
  ...
  h1_my_SigmaIetaIeta_signal_endcap_2021->Draw("same");
  h1_my_SigmaIetaIeta_signal_endcap_2023->Draw("same");
  ...
  my_canvas2->SaveAs("DefaultSieie_years_endcap.png");
