...
int CompareYears_per_rechit_m1p25() {
  ...
  //////// Output File /////////
  TFile* outputFile = new TFile("compare_years_sieie_per_rechit_m1p25.root","RECREATE");
  outputFile->cd();
  ...
  h1_my_SigmaIetaIeta_per_rechit_m1p25_signal_barrel_2024->GetXaxis()->SetTitle("Sieie");
  h1_my_SigmaIetaIeta_per_rechit_m1p25_signal_barrel_2024->SetTitle("");
  h1_my_SigmaIetaIeta_per_rechit_m1p25_signal_barrel_2024->SetStats(0);
  ...
  h1_my_SigmaIetaIeta_per_rechit_m1p25_signal_endcap_2024->GetXaxis()->SetTitle("Sieie");
  h1_my_SigmaIetaIeta_per_rechit_m1p25_signal_endcap_2024->SetTitle("");
  h1_my_SigmaIetaIeta_per_rechit_m1p25_signal_endcap_2024->SetStats(0);
